          ...
          <span className="pagination-summary">
            ...
            {movies.length > 0 && (
              <span className="pagination-count">
                ({((currentPage - 1) * itemsPerPage) + 1} - {Math.min(currentPage * itemsPerPage, movies.length)} of {totalPages * itemsPerPage} results)
              </span>
            )}
          </span>
        </div>
  ...
  const renderError = () => (
    <div className="movie-list-error">
      <div className="error-content">
        ...
        <p>{error || 'Something went wrong while fetching movies. Please try again.'}</p>
